...
const femaleCharacters = starWarsCharacters.filter(ci => ci.gender === "female");
...
*/
const initialCharactersLength = characters.length;
const femaleCharacterNames = femaleCharacters.map(character => character.name);
characters = characters.filter(name => !femaleCharacterNames.includes(name));
const finalCharactersLength = characters.length;
console.log("Lunghezza iniziale di characters: " + initialCharactersLength);
console.log("Lunghezza finale di characters: " + finalCharactersLength);
/* --EXTRA-- ESERCIZIO 10
